 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Esc  | Ins  | Pscr | Menu |      |      |                    |      | PWrd |  Up  | NWrd | DLine| Esc  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  | LAt  | LCtl |LShift|      | Caps |-------.    ,-------|      | Left | Down | Rigth|  Del | Enter|
 * |------+------+------+------+------+------|  MUTE  |    |       |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT(
  ...
  _______ ,  KC_INS , KC_PSCR , KC_APP  , XXXXXXX  , XXXXXXX ,                         KC_PGUP , KC_PRVWD , _______ , KC_NXTWD , KC_DLINE , KC_ESC  ,
  _______ , KC_LALT , KC_LCTL , KC_LSFT , XXXXXXX  , KC_CAPS ,                         KC_LEFT , KC_DOWN  , KC_UP   ,  KC_RGHT ,  KC_DEL  , KC_ENT  ,
